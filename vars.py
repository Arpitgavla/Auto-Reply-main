...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1001566420188 -1002686704351 -1002455191730 -1002216169351').split() if re.match(r'^-?\d+$', channel_id)]
