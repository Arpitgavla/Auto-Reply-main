...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1002005238353 -1001232792540 -1001629066592 -1001763793679').split() if re.match(r'^-?\d+$', channel_id)]
